package com.example.stopewatch;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start = (Button) findViewById(R.id.butten1);
        pause = (Button) findViewById(R.id.butten2);
        reset = (Button) findViewById(R.id.butten3);
        lap = (Button) findViewById(R.id.butten4);
